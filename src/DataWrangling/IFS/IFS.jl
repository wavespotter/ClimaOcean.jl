...
download_IFS_cache::String = ""

function __init__()
    global download_IFS_cache = @get_scratch!("IFS")
end

include("IFS_metadata.jl")
include("IFS_field_time_series.jl")
include("IFS_prescribed_atmosphere.jl")
